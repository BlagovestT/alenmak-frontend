export const DataGridLocale = {
  ...
  toolbarFiltersTooltipActive: (count: number) => `${count} активни филтри`,
  ...
  groupColumn: (name: string) => `Групирай по ${name}`,
  unGroupColumn: (name: string) => `Спри групиране по ${name}`,
